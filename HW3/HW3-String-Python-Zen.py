a = "Beautiful is better than ugly. Explicit is better than implicit.Simple is better than complex.Complex is better than complicated.\
...
print "The quantity of \"better\" is", a.count("better")
print "The quantity of \"never\" is", a.count("never")
